...
public class ContainerMachinistsTable extends Container {
	...
	public ContainerMachinistsTable(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory inventory) {
		craftResult.setInventorySlotContents(0, MachinistsTableCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	
	
	@Override
	public boolean canInteractWith(EntityPlayer entityPlayer) {
		if(worldObj.getBlock(posX, posY, posZ) != BradTech.blockMachinistsTable) {
			return false;
		} else {

...
public class MachinistsTableShapedRecipes implements IRecipe {
	...
	public MachinistsTableShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack) {
	...
	public MachinistsTableShapedRecipes func_92100_c() {
